...
/* !
 * FEATURE.JS 1.1.1, A Fast, simple and lightweight browser feature
...
(function (root, document, factory) {
...
})(typeof self !== 'undefined' ? self : void 0, document, function () {
  'use strict'; // For minification only

  var docEl = document.documentElement; // Protect against undefined window.navigator objects
  ...
  var Feature = {
    ...
    extend: function extend(name, callback) {
    ...
    if (jQuery.isArray(obj)) {
      ...
      jQuery.each(obj, function (i, v) {
        if (traditional || rbracket.test(prefix)) {
          ...
          buildParams(prefix + "[" + (_typeof2(v) === "object" && v != null ? i : "") + "]", v, traditional, add);
        }
      });
...
(function ($, window, document, undefined) {
  ...
  $.fn[lazyLoadXT] = function (overrides) {
    ...
    var blankImage = getOrDef(overrides, 'blankImage'),
        ...
        prop; // empty overrides.scrollContainer is supported by both jQuery and Zepto
    ...
    return this.each(function (index, el) {
      if (el === window) {
        ...
        var duplicate = checkDuplicates && $data(el, dataLazied),
            $el = $(el).data(dataLazied, forceShow ? -1 : 1); // prevent duplicates
  ...
  function triggerEvent(event, $el) {
    ...
    $el.trigger('lazy' + event, [$el]); // queue next check as images may be resized after loading of actual file
  ...
  function checkLazyElements(force) {
    ...
    for (i = 0, length = elements.length; i < length; i++) {
      var $el = elements[i],
          ...
          topEdge; // remove items that are not in DOM
...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof2(module)) === 'object') module.exports = factory(require("./foundation.core"), require("jquery"));else if (typeof define === 'function' && define.amd) define(["./foundation.core", "jquery"], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object') exports["foundation.util.nest"] = factory(require("./foundation.core"), require("jquery"));else root["__FOUNDATION_EXTERNAL__"] = root["__FOUNDATION_EXTERNAL__"] || {}, root["__FOUNDATION_EXTERNAL__"]["foundation.util.nest"] = factory(root["__FOUNDATION_EXTERNAL__"]["foundation.core"], root["jQuery"]);
})(window, function (__WEBPACK_EXTERNAL_MODULE__foundation_core__, __WEBPACK_EXTERNAL_MODULE_jquery__) {
  return (
    /******/
    function (modules) {
    ...
    /******/
    {
      ...
      /***/
      function jsEntriesPluginsFoundationUtilNestJs(module, __webpack_exports__, __webpack_require__) {
        "use strict";
...
(function webpackUniversalModuleDefinition(root, factory) {
  if ((typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object' && (typeof module === "undefined" ? "undefined" : _typeof2(module)) === 'object') module.exports = factory(require("./foundation.core"), require("./foundation.util.keyboard"), require("./foundation.util.nest"), require("jquery"));else if (typeof define === 'function' && define.amd) define(["./foundation.core", "./foundation.util.keyboard", "./foundation.util.nest", "jquery"], factory);else if ((typeof exports === "undefined" ? "undefined" : _typeof2(exports)) === 'object') exports["foundation.accordionMenu"] = factory(require("./foundation.core"), require("./foundation.util.keyboard"), require("./foundation.util.nest"), require("jquery"));else root["__FOUNDATION_EXTERNAL__"] = root["__FOUNDATION_EXTERNAL__"] || {}, root["__FOUNDATION_EXTERNAL__"]["foundation.accordionMenu"] = factory(root["__FOUNDATION_EXTERNAL__"]["foundation.core"], root["__FOUNDATION_EXTERNAL__"]["foundation.util.keyboard"], root["__FOUNDATION_EXTERNAL__"]["foundation.util.nest"], root["jQuery"]);
  ...
  return (
    ...
    /******/
    {
      ...
      /***/
      function foundationUtilNest(module, exports) {
      ...
      /***/
      function jsEntriesPluginsFoundationAccordionMenuJs(module, __webpack_exports__, __webpack_require__) {
        "use strict";
...
(function (window, factory) {
  ...
  function getSize(elem) {
    ...
    if (!elem || _typeof2(elem) != 'object' || !elem.nodeType) {
      return;
    }
...
(function (window, factory) {
  ...
  utils.makeArray = function (obj) {
    ...
    var isArrayLike = _typeof2(obj) == 'object' && typeof obj.length == 'number';
...
document.documentElement.className = "js"; // add message

console.info("%cThis site was build with love by " + "%c(https://dominicvogl.de)", "", "color: #2199e8; background-color: #000"); // check if svg is available in this browser
...
(function ($) {
  $(function () {
    $(document).foundation(); // Init accordion in mobile navigation

    var mobileNavigation = new Foundation.AccordionMenu($('.js-accordion-menu'));
  });
})(jQuery);
...
(function ($) {
  $(function () {
    ...
    $grid.on('layoutComplete', function () {// Your settings
    });
...
})(jQuery); // import { MediaQuery } from 'foundation-sites';
...
(function ($) {
  $(function () {
    ...
    initTogglerPadding(toggler); // Events
