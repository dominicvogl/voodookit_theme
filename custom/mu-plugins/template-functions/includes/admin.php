...
function bwrk_remove_footer_admin() {
...
add_filter('admin_footer_text', 'bwrk_remove_footer_admin');
...
function bwrk_shapeSpace_screen_layout_columns($columns) {
    $columns['dashboard'] = 2;
    return $columns;
}

function bwrk_shapeSpace_screen_layout_dashboard() {
    return 2;
}

// Execute functions via filter
add_filter('screen_layout_columns', 'bwrk_shapeSpace_screen_layout_columns');
add_filter('get_user_option_screen_layout_dashboard', 'bwrk_shapeSpace_screen_layout_dashboard');
