...
function cccc_post_thumbnails($size) {
...
function cccc_get_attachement_alt($attachementID) {
...
function cccc_get_post_category_names() {
...
function cccc_get_term_id($taxonomy) {
...
function cccc_get_converted_date($date) {
...
function cccc_get_terms_str($taxonomy) {
