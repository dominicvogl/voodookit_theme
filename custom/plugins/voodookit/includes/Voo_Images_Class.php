...
$Voo_Images = new Voo_Images;

//
// Author: Dominic Vogl
// Description: Various public functions for rendering images in Wordpress and add SVG support
// ----------------------------------------------------------------------------------------------------------------------
...
class Voo_Images
{
	...
	//
	// Render image tag with size of svg's and a better image rendering as the original wp public function! Check it out =)
	// ----------------------------------------------------------------------------------------------------------------------

	public function bwrk_get_image($attachmentID, $size_args = 'thumbnail', $is_lazy = false, $echo = true, $elem_args = array())
	{
...
// ------------------------------------------------------
	...
	public function bwrk_get_attachment($attachment_id)
	{
...
// ------------------------------------------------------
	...
	public function bwrk_get_image_sizes($size = '')
	{
	...
	public function bwrk_get_srcset_image($image_ID, $image_sizes = array())
	{
	...
	public function wp_get_attachment_meta($attachment_id)
	{
