...
function bwrk_get_image($attachmentID, $size_args = 'thumbnail', $is_lazy = false, $echo = true, $elem_args = array() ) {
...
function bwrk_get_attachment($attachment_id) {
...
function bwrk_get_image_sizes( $size = '' ) {
...
function bwrk_get_srcset_image($image_ID, $image_sizes = array()) {
