...
class Voo_Helper
{
   ...
   public function is_post_format($post_id, $format)
   {
   ...
   public function is_page_type($format)
   {
   ...
   public function get_lang_from_browser($allowed_languages, $default_language, $lang_variable = NULL, $strict_mode = TRUE)
   {
